...
public class ordenacaoslcparc
{
    ...
    {
        FileWriter arquivo = new FileWriter("matricula_selecaoparcial.txt");
    ...
    public static void OrdenarVetor(Personagem[] p,int k)throws Exception
    {
    ...
    public static void imprimir(int k)throws Exception
    {
