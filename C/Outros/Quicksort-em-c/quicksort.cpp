...
void quicksortRec (int esq, int dir)
{
    ...
    while (i <= j)
    {
        ...
        (strcmp(personagens[i].corDoCabelo,pivo.corDoCabelo)==0 && strcmp(personagens[i].nome,pivo.nome)<0))
        {
            numcpr++;
            i++;
        }
        ...
        (strcmp(personagens[j].corDoCabelo,pivo.corDoCabelo)==0 && strcmp(personagens[j].nome,pivo.nome)>0))
        {
            numcpr++;
            j--;
        }
