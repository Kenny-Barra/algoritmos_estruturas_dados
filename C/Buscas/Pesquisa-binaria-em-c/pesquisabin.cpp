...
void salvarArq(double tempo)
{
    ...
    fprintf(arq,"645412\t%lf\t%d",tempo,numcpr);
...
void imprimir()
{
    ...
    for(i=0;i<nump;i++)
    {
        printf("[%d]  ## %s ## %d ## ",i,personagens[i].nome,personagens[i].altura);
